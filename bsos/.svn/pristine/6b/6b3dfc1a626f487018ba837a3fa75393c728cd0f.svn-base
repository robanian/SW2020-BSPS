...
import com.bsos.beans.Beans;
import com.bsos.beans.BeansServiceImpl;
import com.bsos.cart.Product;
import com.bsos.member.Member;
import com.bsos.order.orderhistory.OrderHistory;
import com.bsos.order.orderhistory.OrderHistoryServiceImpl;
import com.bsos.order.ordersheet.OrderSheet;
import com.bsos.order.ordersheet.OrderSheetServiceImpl;
import com.bsos.payment.paymenthistory.PaymentHistory;
import com.bsos.payment.paymenthistory.PaymentHistoryServiceImpl;
	...
	private void decreaseStockWeight(OrderSheet orderSheet) {
		...
		try {
			...
			for (Beans bean : beansList) {
				System.out.println(bean.getStockWeight());
